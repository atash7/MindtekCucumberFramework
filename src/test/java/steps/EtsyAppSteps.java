...
public class EtsyAppSteps {
    ...
    public void userAppliesPriceFilterOverDollars(String filterRange) {
        ...
        if (filterRange.equals("over 1500")) {
            ...
            etsyAppSearchResultsPage.filterRadioBtnUnder250.click();
        } else if (filterRange.equals("250 to 750")) {
            etsyAppSearchResultsPage.filterRadioBtn250to750.click();
        } else if (filterRange.equals("500 to 1000")) {
            etsyAppSearchResultsPage.filterRadioBtn500to1000.click();
        }
        etsyAppSearchResultsPage.applyBtn.click();
    }

    @Then("user validates that item price are over {string} dollars")
    public void userValidatesThatItemPriceAreOverDollars(String filterRange) throws InterruptedException {
        ...
        if (filterRange.equals("over 1500")) {
            ...
            for (WebElement element : prices) {
                ...
                Assert.assertTrue(actualPriceDbl >= expectedPriceDbl);
            }
        } else if (filterRange.equals("under 250")) {
            Thread.sleep(3000);
            List<WebElement> prices = etsyAppSearchResultsPage.listOfItemsPrices;
